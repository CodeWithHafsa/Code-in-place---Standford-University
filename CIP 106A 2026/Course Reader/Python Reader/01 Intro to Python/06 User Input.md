...
By the end of this section, you should be able to get input from the user and understand how to properly access it. So what is the secret behind getting user input? 

The syntax of the <span style="color: #4c61d4"> input </span>  function is written below: 
