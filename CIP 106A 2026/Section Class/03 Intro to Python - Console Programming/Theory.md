...
A few years ago, NASA made history with the first controlled flight on another planet. Its latest Mars Rover, Perseverance, has onboard a 50cm high helicopter called Ingenuity. Ingenuity made its [third flight](https://www.nytimes.com/2021/04/25/science/mars-helicopter-nasa.html), during which it flew faster and further than it had on any of its test flights on Earth. Interestingly, Ingenuity [uses Python](https://github.com/readme/featured/nasa-ingenuity-helicopter) for some of its flight modeling software!
