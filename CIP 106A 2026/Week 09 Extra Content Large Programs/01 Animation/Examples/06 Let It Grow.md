...
1. Storing the information about a shape from our canvas
2. Deleting the original shape from the canvas
3. Using the stored information to remake the object with any transformations we may like.
