...
Here is a demo with a few extensions: [Baby Snake Demo](https://codeinplace.stanford.edu/cip3/share/gy05Az3r7HyrDK7t8oUx)

---
#### Milestone #1: Set up the World

Draw the following world! It has a blue square is the "<span style="color: #4a48ec;">**player** </span>" the red square is the "<span style="color: #c76874;"> goal </span>". The player and the goal are both 20 pixels by 20 pixels. 

The player should start in the top left corner of the world. You can place the goal anywhere you like **as long as** its x and y values are both<span style="color: #76afdd;"> multiplies of 20  </span>. Here is a reasonable configuration where the goal is at (360, 360):
